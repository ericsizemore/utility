...
Backward compatibility can be ignored in security bug fixes or critical bugs. In this case, all the incompatible changes are described in the [CHANGELOG](https://github.com/ericsizemore/utility/blob/master/CHANGELOG.md).
